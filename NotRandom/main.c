...
int main(int argc, char const *argv[])
{
	...
	if(isTrain)
		execDissTrain("/home/guilherme/Documentos/Projeto_Diego/Scripts/BFL_115_128_2048_Diss.Train",115,9,18,2049);
	else
		execDissTest("/home/guilherme/Documentos/Projeto_Diego/Scripts/BFL_115_128_2048_Diss.Test",115,9,9,2049);
